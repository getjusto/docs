---
title: "Modificación de un pedido"
---

El webhook de tipo `orderItemsUpdated` se activa cuando un pedido es modificado.

### Estructura

Se enviará la información del pedido con el formato Order.

    - `order`: Orden modificada
