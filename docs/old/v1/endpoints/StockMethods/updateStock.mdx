...
Como precondición, se debe configurar el webhook [Actualización de estado de procesos](https://docs.getjusto.com/docs/old/v1/endpoints/webhooks/processStatusUpdated).
