...
# Consideraciones importantes
    ...
    - Para dejar de que un producto o modificador dependa de un stock y aparezca siempre disponible, se debe hacer un request a [deleteOutOfStockItem](https://docs.getjusto.com/docs/old/v1/endpoints/StockMethods/deleteOutOfStockItem) con el ID del stock.
