...
openapi: patch /products/itemsStock
---
...
# Consideraciones importantes
    ...
    - Para dejar de que un producto o modificador dependa de un stock y aparezca siempre disponible, se debe hacer un request a [deleteOutOfStockItem](https://docs2.getjusto.com/docs/old/v2/endpoints/products/deleteOutOfStockItem) con el ID del stock.
