...
description: Busca productos dentro de un menú del website.
---

Busca productos dentro de un menú del website.
...
```http
GET /v3/ordering/websites/{domain}/products/search
```
...
<ResponseField name="data" type="OrderingProductSearchData" required>
