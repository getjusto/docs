---
title: Get customer
description: Obtiene el customer propio de la app autenticada.
---

Obtiene el customer propio de la app autenticada.
...
```http
GET /v3/ordering/customers/{externalCustomerId}
```
