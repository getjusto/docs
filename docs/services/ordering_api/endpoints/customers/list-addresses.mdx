...
description: Lista direcciones reutilizables del customer en todos los websites.
---

Lista direcciones reutilizables del customer en todos los websites.
...
<ResponseField name="data" type="OrderingAddress[]" required>
  Direcciones guardadas del customer.
</ResponseField>
