...
description: Lista órdenes creadas por la app autenticada para el customer.
---

Lista órdenes creadas por la app autenticada para el customer.
...
<ParamField name="page" type="number">
...
<ResponseField name="data" type="OrderingOrdersPage" required>
  Página de órdenes del customer.
</ResponseField>
