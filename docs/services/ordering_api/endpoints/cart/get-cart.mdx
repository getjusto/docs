---
title: Get cart
description: Obtiene preferencias, dirección, local, horarios, medios de pago y carrito calculado.
---

Obtiene preferencias, dirección, local, horarios, medios de pago y carrito calculado.
