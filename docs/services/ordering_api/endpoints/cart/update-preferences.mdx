...
description: Actualiza local, tipo de entrega, horario, medio de pago, cupón y coins.
---

Actualiza local, tipo de entrega, horario, medio de pago, cupón y coins.
...
<ParamField name="storeId" type="string">
...
<ParamField name="placeId" type="string">
  Place ID seleccionado.
</ParamField>

<ParamField name="deliveryType" type="string">
  `delivery`, `go` o `serve`.
</ParamField>

<ParamField name="paymentType" type="string">
  Medio de pago seleccionado.
</ParamField>

<ParamField name="otherPaymentType" type="string">
  Subtipo de pago, si aplica.
</ParamField>

<ParamField name="couponCode" type="string">
  Código de cupón aplicado.
</ParamField>

<ParamField name="time" type="string">
  `now` o un `value` retornado por cart/times.
</ParamField>

<ParamField name="dropOffType" type="string">
  Tipo de entrega en destino.
</ParamField>

<ParamField name="tableName" type="string">
...
<ParamField name="justoCoinsToSpend" type="number">
  Justo Coins a usar.
</ParamField>

<ParamField name="websiteCoinsToSpend" type="number">
...
<ResponseField name="data" type="OrderingCartState" required>
