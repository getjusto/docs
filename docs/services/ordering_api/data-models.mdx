...
<ResponseField name="selectedAddressId" type="string | null">
  Dirección seleccionada globalmente para este customer y app.
</ResponseField>

<ResponseField name="selectedPlaceId" type="string | null">
  Place ID seleccionado para cobertura y cálculo de carrito.
</ResponseField>

<ResponseField name="selectedCityId" type="string | null">
  City ID asociado a la dirección seleccionada, si está disponible.
</ResponseField>
