...
También puedes configurar el webhook para que Justo envíe el token del webhook directamente en el header `Authorization`, usando el mismo formato que se usa para autenticar requests hacia Justo:
