...
Justo firma cada webhook con el secreto configurado al crear el webhook. La firma permite validar que el request fue enviado por Justo y que el payload no fue modificado.
